...
final class EmptyTrainingPlanService: TrainingPlanServiceProtocol {
    ...
    func addPlannedExercises(_ drafts: [PlanExerciseDraft], planDate: String) async throws -> TrainingPlanDay {
        try await local.addPlannedExercises(drafts, planDate: planDate)
    }

    func reorderPlannedExercises(orderedExerciseIds: [String], planDate: String) async throws -> TrainingPlanDay {
        try await local.reorderPlannedExercises(orderedExerciseIds: orderedExerciseIds, planDate: planDate)
    }
